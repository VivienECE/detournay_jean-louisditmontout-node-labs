...
app.get('/channels/:id/messages', async (req, res) => {
  const messages = await db.messages.list() //On appel la fonction list de notre module "db" qui va nous retourner tous les messages stockés en base de données
...
app.get('/users', async (req, res) => {
  const users = await db.users.list() //On appel la fonction list de notre module "db" qui va nous retourner tous les users stockés en base de données
